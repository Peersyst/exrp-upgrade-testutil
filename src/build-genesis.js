...
const XRP_SUPPLY = "99999995624329824754009150770";
const HISTORICAL_REWARDS = 46;
...
const f = (gs) => {
    ...
    gs.app_state.distribution.validator_historical_rewards = [{
        ...
        "rewards": {
            ...
            "reference_count": HISTORICAL_REWARDS
        },
        "validator_address": VALIDATOR_ADDRESS,
    }];
    ...
    const wstream = fs.createWriteStream(process.argv[3]);
